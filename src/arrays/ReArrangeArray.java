...
public class ReArrangeArray {
     ...
     *
     * <p>
     * Create two arrays one will store positive numbers and other will store negative numbers. Now iterate through the input array and keep filtering positive and
     * negative numbers and keep putting them into respective arrays. Now either create new array or utilize the input array only, iterate through it again and
